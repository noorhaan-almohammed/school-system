document.addEventListener('DOMContentLoaded', function () {
            ...
            if (modalType) {
                ...
                fetch(`/teachers/${teacherId}`)
                    ...
                    .then(data => {
                        ...
                        document.getElementById('edit-teacher-email').value = data.email;
                        document.getElementById('edit-teacher-phone').value = data.phone_number || '';
    ...
    editTeacherForm.addEventListener('submit', function (e) {
        ...
        .then(data => {
            ...
            const teacherRow = document.querySelector(`tr[data-id="${id}"]`);
            if (teacherRow) {
